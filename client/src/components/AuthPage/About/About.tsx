...
export default function About() {
  ...
  const faq2 = "You can find quests created by community memebers on the find tab. Find a quest that fits your style and click accept. You will then have your own copy of the quest that tracks your progress!"
  ...
  return (
    <main className="h-[95vh] bg-mq-boring">
      <div className=" bg-cover bg-[60%_0%] lg:h-[60%] h-1/3 lg:bg-center lg:p-10 p-4 flex items-start lg:items-end shadow-xl" style={{backgroundImage: `url('${mickeyUrl}')`}}>
          <div className="2xl:w-1/3 xl:w-1/2 w-full h-fit bg-white/85 rounded-2xl backdrop-blur-sm text-center xl:p-8 p-3">
            <p className="lg:text-2xl 2xl:text-xl uppercase text-xs font-semibold xl:text-left mb-1 italic">✨ Disneyland Scavenger hunts ✨</p>
      ...
      <h1 className="text-center font-black uppercase tracking-wider lg:text-3xl text-xl mt-10 lg:mb-6 mb-0">About MouseQuest / FAQ</h1>
      <div className="bg-mq-boring h-[60%] p-4 w-full text-center">
        <Faq title={"What is MQ?"} desc={faq1}/>
