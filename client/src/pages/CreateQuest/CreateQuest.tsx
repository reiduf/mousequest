...
export default function CreateQuest() {
  return (
    <main>
      <div className="relative flex justify-center items-center w-full mx-auto lg:h-[30rem] h-60 bg-center bg-no-repeat bg-cover" style={{backgroundImage: `url('${jungleUrl}')`}}>
