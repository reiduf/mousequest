...
export default function AddTaskForm({addTask}: Props) {
  ...
  return(
       <form onSubmit={handleAddTask} className="flex flex-col justify-center text-center mt-2">
        <label className="font-black uppercase tracking-wider mb-2">4. Add tasks - at least 3! <span className="text-red-400 font-normal">*</span></label>
        <textarea required placeholder="Task details..." className="p-3 mb-4 h-36 rounded-md" name="description" value={taskDetails.description} onChange={handleChange}></textarea>
