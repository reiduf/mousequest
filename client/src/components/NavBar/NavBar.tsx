...
export default function NavBar({user, setUser}: Props) {
  ...
  return (
    <nav className="py-3 text-center lg:px-14 px-2 flex justify-center lg:justify-between fixed lg:relative bottom-0 left-0 right-0 bg-white lg:border-0 border-t border-slate-300 z-20" >
