  ...
  return(
    <>
      <div className="flex items-center justify-center gap-8 relative">
        { quest.taskProgress.every(task => task) &&     
          <div className="absolute z-10 w-screen h-screen flex items-center justify-center backdrop-blur-sm">
            <div className="bg-mq-purple shadow-2xl xl:w-1/2 lg:h-1/2 w-[90%] h-1/4 rounded-3xl flex flex-col items-center justify-center gap-8">
              <div>
                <p className="text-yellow-400 mb-5 font-black lg:text-7xl text-3xl tracking-wider uppercase text-center"> quest complete </p>
                <p className="text-white font-black lg:text-5xl text-xl tracking-wider uppercase text-center cursor-pointer">✨ Congratulations! ✨</p>
              </div>
              <Link to='/quests/accepted-quests'>
                <button className="mt-3 bg-white px-5 py-2 uppercase font-black tracking-wide rounded-md">Back to accepted quests</button>
              </Link>
            </div>
          </div>
        }
