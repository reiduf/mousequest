export default function NotFoundPage() {
  return (
    <main className="mq-bg flex flex-col items-center gap-3">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-32 mt-20">
      ...
      <h1 className=" text-6xl mt-8 font-black uppercase">Oops!</h1>
      <p className="text-4xl font-extrabold">You've wandered into uncharted territories. </p>
      <p className="text-4xl font-extrabold">Please check your URL </p>
    </main>
  )
}