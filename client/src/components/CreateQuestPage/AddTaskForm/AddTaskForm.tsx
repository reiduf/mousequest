...
export default function AddTaskForm({addTask}: Props) {
  ...
  return(
    <form onSubmit={handleAddTask} className="flex flex-col justify-center text-center my-5">
      <label className="font-black uppercase tracking-wider mb-2" htmlFor="">Task Details</label>
